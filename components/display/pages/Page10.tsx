...
export default function Page10() {
    ...
    if (videoAudioPlayerRef.current) {
      ...
      if (videoAudioInternalPlayer) {
        if (videoAudioInternalPlayer.volume !== undefined) {
          videoAudioInternalPlayer.volume = 1; // 视频音频音量设为最大
        }
  ...
  // 监听页面控制命令
  usePageControl(10, handlePageControl);
  ...
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative' }}>
      ...
      >
        <ReactPlayer
          ref={playerRef}
          url="/assets/videos/两只小象呦啰啰转场.mp4"
          playing={isPlaying}
          loop={false}
          muted={volume === 0}
          controls={false}
